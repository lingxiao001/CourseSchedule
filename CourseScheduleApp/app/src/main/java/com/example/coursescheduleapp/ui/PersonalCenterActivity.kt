...
class PersonalCenterActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val userJson =
            getSharedPreferences("user", Context.MODE_PRIVATE).getString("user_json", null)
                            ...
                            confirmButton = {
                                Button(onClick = {
                                    ...
                                    scope2.launch {
                                        ...
                                        val result = resetPasswordRepository.resetPassword(
                                            username,
                                            oldPwd,
                                            newPwd
                                        )
                                        if (result.isSuccess) {
                                            ...
                                            val error =
                                                result.exceptionOrNull()?.message ?: "重置失败"
                                            errorMsg = error
